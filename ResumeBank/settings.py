"""
Django settings for ResumeBank project.
...
# Local secrets live in <repo>/.env (gitignored); see .env.example.
...
# keeping secret key as an env variable
...
WSGI_APPLICATION = 'ResumeBank.wsgi.application'
